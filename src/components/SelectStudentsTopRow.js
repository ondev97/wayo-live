...
export default function SelectStudentsTopRow({addedProfile,setselectst,setaddedProfile,selectst,addStudemts}) {
        ...
        <div>
           {
                ...
                <div className="top_head_row">
                                        ...
                                        <div className="scard" key={index}>
                                            <div className="relcard">
                                                <div className="rembut">
                                                    <button onClick={()=>removeTop(index)}><i className="fas fa-minus-circle"></i></button>
                                                </div>
                                                <div className="sestimage">
                                                    <LazyLoadImage src={data.img} effect="blur" alt={data.un} />
                                                </div>
                                            </div>
                                            <div className="name">
                                                <h3>{data.un}</h3>
                    ...
                    <div className="added_main">
                        <button title="Add Students" onClick={addStudemts}><i className="fas fa-chevron-circle-right"></i></button>
                    </div>
                </div>
                : ""
            } 
