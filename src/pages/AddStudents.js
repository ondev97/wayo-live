...
export default function AddStudents() {
    ...
    const getStudents = async () =>{
        await Axios.get(`${process.env.REACT_APP_LMS_MAIN_URL}/account-api/getstudents/${cid}/?page=${page}&search=${search}`,{
    ...
    const addStudemts = async () =>{
        await Axios.post(`${process.env.REACT_APP_LMS_MAIN_URL}/course-api/enrollcoursebyteacher/${cid}/`,{
            students:selectst
        },{
            headers:{Authorization:"Token "+usDetails.key}
        }).then(()=>{
    ...
    return (
        <div className="stlist">
            ...
            <SelectStudentsTopRow addedProfile={addedProfile} setselectst={setselectst} setselectst={setselectst} setaddedProfile={setaddedProfile} selectst={selectst} addStudemts={addStudemts}/>
